...
def save_to_npy(
    ...
    log_prob_theta_true: np.ndarray,
) -> None:
    """
    ...
    Args:
        ...
        log_prob_theta_true: Log probabilities of the true theta values.
    """
        
    np.save(output_dir / "posterior_distribution.npy", samples)
    np.save(output_dir / "posterior_log_probs.npy", log_prob_samples)
    np.save(output_dir / "posterior_log_probs_true_theta.npy", log_prob_theta_true)
